...
public class Controller {
	...
	public String homePage(Model model) {
		// Age moyen
		String averageAgeApiUrl = "http://" + IPADDRESS + ":5000/average_age";
		...
		String crepeApiUrl = "http://" + IPADDRESS + ":5000/best_item";
		...
		String averageCostApiUrl = "http://" + IPADDRESS + ":5000/average_amount";
		...
		String paymentMethodsApiUrl = "http://" + IPADDRESS + ":5000/payment_method";
	...
	public String ticketsPage(Model model) {
		String apiUrl = "http://" + IPADDRESS + ":5000/all_receipts_per_client";
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create(apiUrl))
				.build();
	...
	public String averageAgePage(Model model) {
		String apiUrl = "http://" + IPADDRESS + ":5000/average_age";
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create(apiUrl))
				.build();
